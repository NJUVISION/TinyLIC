...
class FastNIC(CompressionModel):
    def __init__(self, **kwargs):
        ...
        self.g_a = nn.Sequential(
            ...
            nn.Conv2d(48, 296, kernel_size=2, stride=2),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ...
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            nn.Conv2d(296, 256, kernel_size=2, stride=2),
            ResidualBlock(256, 256, n_div=1),
            ResidualBlock(256, 256, n_div=1),
        )

        self.g_s = nn.Sequential(
            ResidualBlockUpsample(256, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ...
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlockUpsample(296, 48, n_div=1),
            ResidualBlock(48, 48, n_div=1),
            nn.PixelShuffle(4),
        )

        self.h_a = nn.Sequential(
            ResidualBlockWithStride2(256, 296),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlockWithStride2(296, 160),
        )

        self.h_s = nn.Sequential(
            ResidualBlockUpsample2(160, 296),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlock(296, 296, n_div=1),
            ResidualBlockUpsample2(296, 256),
        )
        ...
        self.cc_transforms = nn.ModuleList(
            nn.Sequential(
                ...
                nn.Conv2d(int(256 // self.num_slices) * self.max_support_slices, 296, 1),
                WSiLU(),
                nn.Conv2d(296, 296, kernel_size=5, padding=2, stride=1, groups=296),
                nn.Conv2d(296, int(296 // self.num_slices) * 3, 1),
                WSiLU(),
                nn.Conv2d(int(296 // self.num_slices) * 3, int(296 // self.num_slices) * 3, kernel_size=5, padding=2, stride=1, groups=int(296 // self.num_slices) * 3),
                nn.Conv2d(int(296 // self.num_slices) * 3, int(296 // self.num_slices) * 3, 1),
                WSiLU(),
                nn.Conv2d(int(296 // self.num_slices) * 3, int(256 // self.num_slices) * 2, 1),
